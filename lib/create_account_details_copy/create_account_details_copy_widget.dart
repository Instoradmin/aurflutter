...
class CreateAccountDetailsCopyWidget extends StatefulWidget {
  const CreateAccountDetailsCopyWidget({Key? key}) : super(key: key);

  @override
  _CreateAccountDetailsCopyWidgetState createState() =>
      _CreateAccountDetailsCopyWidgetState();
}

class _CreateAccountDetailsCopyWidgetState
    extends State<CreateAccountDetailsCopyWidget> {
